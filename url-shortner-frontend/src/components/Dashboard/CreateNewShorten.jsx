...
const CreateNewShorten = ({ setOpen, refetch }) => {
  ...
  const createShortUrlHandler = async (formData) => {
    ...
    try {
      ...
      // ✅ Immediately refresh the list in the dashboard
  ...
  return (
    <div className="flex justify-center items-center bg-white rounded-md">
      ...
      >
        ...
        <button
          className="bg-customRed font-semibold text-white w-32 bg-custom-gradient py-2 transition-colors rounded-md my-3 disabled:opacity-60"
          type="submit"            
          disabled={loading}
        >
